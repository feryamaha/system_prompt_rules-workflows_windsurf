## PEDIDO
Atualizar instalador GenesisIA (index.js) para implementar lógica de instalação diferenciada: arquivos core sempre sobrescrevem, templates são seletivos, e proteção contra sobrescrita solicita confirmação do usuário quando o Genesis já está instalado
...
- Fluxo de decisão:
  1. Verificar se Genesis está instalado (checar existência de .windsurf/, Feature-Documentation/, src/workflow-enforcement/, .genesis/)
