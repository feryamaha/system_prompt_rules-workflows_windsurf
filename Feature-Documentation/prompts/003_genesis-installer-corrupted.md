## PEDIDO
Corrigir instalador do GenesisIA Skills SPRW que esta falhando ao instalar estrutura completa em projetos alvo via comando npx github:feryamaha/system_prompt_rules-workflows_windsurf, incluindo pastas padrao (.windsurf/rules, Feature-Documentation), nova camada de prevenção e contenção (Workflow Enforcement Engine + just-bash Sandbox), e Vercel Agent Skills automaticamente
...
- Contexto: Instalador GenesisIA modificado durante implementacao do Workflow Enforcement Engine + just-bash (PR_004)
- Arquivos envolvidos: 
...
- Comportamento esperado: 
  - Copiar estruturas do pacote Genesis para projeto alvo (.windsurf/rules, Feature-Documentation)
