# Issue 003: Correção do Instalador GenesisIA - Registro Completo da Interação

## 1. Descrição da Issue

**Arquivos:**
- `index.js` (instalador GenesisIA corrompido)
- `Feature-Documentation/prompts/003_genesis-installer-corrupted.md` (RAG gerado)
- `Feature-Documentation/to-do-list/to-do-list-genesis-installer-corrupted.md` (tarefas de correção)
...
**Objetivo:** Documentar interação completa entre usuário e IA para correção do instalador GenesisIA Skills SPRW, registrando erros, acertos e lições aprendidas.

**Contexto Técnico:**
- Instalador GenesisIA falhava ao copiar estruturas para projetos alvo
...
**Pedido:** Analisar situação legada do projeto e identificar causa do erro no instalador Genesis.
...
- `Feature-Documentation/prompts/003_genesis-installer-corrupted.md` (RAG)
- `Feature-Documentation/to-do-list/to-do-list-genesis-installer-corrupted.md` (tarefas)
- `Feature-Documentation/issues/003_issue-genesis-installer-correction.md` (esta issue)
...
genesis-installer, workflow-violation, generate-prompt-rag, bugfix, path-correction, PACKAGE_ROOT, caminhos-relativos, nodejs, npx, instalador
